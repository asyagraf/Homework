...
namespace CarRentalService.Controllers
{
    ...
    public class RentalCarController : ControllerBase
    {
        ...
        {
            return (await req.GetResponse<AllRentalCarsResponse>(new AllRentalCarsRequest())).Message.Cars;
        }

        [HttpPost]
        public async Task Create([FromServices] IRequestClient<CreateRentalCarRequest> req, [FromBody] CreateRentalCarRequest create)
        {
            await req.GetResponse<CUDRentalCarResponse>(create);
        }
        ...
        {
            await req.GetResponse<CUDRentalCarResponse>(update);
        }
    }
}
